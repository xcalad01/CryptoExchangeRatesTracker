...
/* harmony import */ var _plugins_axios__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ../../plugins/axios */ "./resources/js/plugins/axios.js");
/* harmony import */ var humanize_plus__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! humanize-plus */ "./node_modules/humanize-plus/dist/humanize.js");
/* harmony import */ var humanize_plus__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(humanize_plus__WEBPACK_IMPORTED_MODULE_2__);
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  computed: {
    currency_day_price: function currency_day_price() {
      ...
      return currency_symbol_map__WEBPACK_IMPORTED_MODULE_0___default()(this.post.to.toUpperCase()) + " " + humanize_plus__WEBPACK_IMPORTED_MODULE_2___default.a.formatNumber(this.day_price, 5);
    },
    currency_h24_min: function currency_h24_min() {
      if (this.h24_min == null) {
        return null;
      }

      return currency_symbol_map__WEBPACK_IMPORTED_MODULE_0___default()(this.post.to.toUpperCase()) + " " + humanize_plus__WEBPACK_IMPORTED_MODULE_2___default.a.formatNumber(this.h24_min, 5);
    },
    currency_h24_max: function currency_h24_max() {
      if (this.h24_max == null) {
        return null;
      }

      return currency_symbol_map__WEBPACK_IMPORTED_MODULE_0___default()(this.post.to.toUpperCase()) + " " + humanize_plus__WEBPACK_IMPORTED_MODULE_2___default.a.formatNumber(this.h24_max, 5);
    },
    currency_all_time_min: function currency_all_time_min() {
      if (this.all_time_min == null) {
        return null;
      }

      return currency_symbol_map__WEBPACK_IMPORTED_MODULE_0___default()(this.post.to.toUpperCase()) + " " + humanize_plus__WEBPACK_IMPORTED_MODULE_2___default.a.formatNumber(this.all_time_min, 5);
    },
    currency_all_time_max: function currency_all_time_max() {
      if (this.all_time_max == null) {
        return null;
      }

      return currency_symbol_map__WEBPACK_IMPORTED_MODULE_0___default()(this.post.to.toUpperCase()) + " " + humanize_plus__WEBPACK_IMPORTED_MODULE_2___default.a.formatNumber(this.all_time_max, 5);
    },
  ...
  methods: {
    ...
    update_supply: function update_supply(data) {
      this.total_supply = humanize_plus__WEBPACK_IMPORTED_MODULE_2___default.a.formatNumber(data['data']['total_supply']);

      if (data['data']['circulating_supply'] !== null) {
        this.circulating_supply = humanize_plus__WEBPACK_IMPORTED_MODULE_2___default.a.formatNumber(data['data']['circulating_supply']);
      } else {
    ...
    init_available: function init_available() {
      ...
      var uri = "http://" + "167.86.75.179" + ":" + "8001" + "/api/fiat/all_supported";
      this.axios.get(uri).then(function (response) {
        return _this5.finish_init_avail(response.data);
      });
    },
    finish_init_avail: function finish_init_avail(data) {
      var formatted = data['data'].map(function (item) {
    ...
    _c("div", { staticClass: "row" }, [
      ...
      _c("div", { staticClass: "p-col-12 p-lg-4" }, [
        _c("div", { staticClass: "card" }, [
          ...
          _c("span", { staticClass: "span_value" }, [
            _vm._v(
              " " +
                _vm._s(_vm.currency_h24_min) +
                " / " +
                _vm._s(_vm.currency_h24_max) +
                " "
            )
          ])
        ])
      ...
      _c("div", { staticClass: "p-col-12 p-lg-4" }, [
        _c("div", { staticClass: "card" }, [
          ...
          _vm._v(" "),
          _c("span", { staticClass: "span_value" }, [
            _vm._v(" " + _vm._s(_vm.currency_all_time_min) + " ")
          ]),
          _vm._v(" "),
      ...
      _c("div", { staticClass: "p-col-12 p-lg-4" }, [
        _c("div", { staticClass: "card" }, [
          ...
          _vm._v(" "),
          _c("span", { staticClass: "span_value" }, [
            _vm._v(" " + _vm._s(_vm.currency_all_time_max) + " ")
          ]),
          _vm._v(" "),
